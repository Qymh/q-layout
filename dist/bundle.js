(function (global, factory) {
	...
	(global = global || self, global.QLayout = factory());
	...
	***************************************************************************** */
	...
	function generateProps(propsCollections) {
	    return propsCollections.reduce(function (acc, val) {
	        acc[val.value] = {
	            type: val.type,
	            default: val.default
	        };
	...
	var sizeProps = generateProps(sizeCollections);

	var QRow = vueCompositionApi_2({
	    props: __assign({}, sizeProps),
